  ...
  >
    <q-card flat square>
      <q-card-section>
        ...
        <p>
          On most pages, you can see the header at the top for quick access to
          the Dashboards and Settings.
        </p>
        ...
        <p>
          On the Examples page, you can click the star icons to favorite or
          unfavorite items. You can also click the vertical dot icon to access
          record options like charts, inspect, edit, and delete.
        </p>
        ...
        <p>
          On the Settings page, you can access app wide options, manage your
          data, and more.
        </p>
        ...
        <p>
          Clicking the purple context menu button will open additional options
          for the current page. These typically include links to the data tables
          for the current records, the option to create a record, and more.
        </p>
        ...
        <p>
          Clicking the database button will open the database page where you can
          view and manage your records on a data table like you might see in a
          spreadsheet.
        </p>

        <p>
          Hope you find {{ appName }} useful. Please consider donating to help
          me continue to create and maintain apps like this. Thank you!
        </p>
