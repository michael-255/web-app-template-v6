    ...
    <q-list padding>
      ...
      <q-item>
        <q-item-section top>
          ...
          <q-item-label caption>
            Import your data from a JSON or CSV file. The app expects the data
            in the file to be structured the same as the exported version.
          </q-item-label>
        </q-item-section>
      </q-item>
      ...
      <q-item>
        <q-item-section top>
          ...
          <q-item-label caption>
            Export your data as a JSON or CSV file. Do this on a regularly basis
            so you have a backup of your data.
          </q-item-label>
        </q-item-section>
      </q-item>
      ...
      <q-item v-if="isDevMode">
        <q-item-section top>
          ...
          <q-item-label caption>
            Generate many records of test data for the app. This can be
            repeated.
          </q-item-label>
        </q-item-section>
      </q-item>
